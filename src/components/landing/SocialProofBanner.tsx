...
const SocialProofBanner = () => {
  ...
  return (
    <section className="relative border-t-2 border-b-2 border-[#1A1A1A] bg-[#FAFAF8] py-8 overflow-hidden">
      {/* Background Pattern */}
      <div className="absolute inset-0 opacity-5 pointer-events-none">
        <div className="absolute top-0 left-0 w-full h-px bg-[#1A1A1A]" />
        <div className="absolute bottom-0 left-0 w-full h-px bg-[#1A1A1A]" />
      </div>

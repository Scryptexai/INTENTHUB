  ...
  return (
    <>
      ...
      >
        ...
        {/* Desktop version - only show on desktop */}
        {!isMobile && (
        ...
        {/* Mobile Version - only show on mobile */}
        {isMobile && (
          <div className="absolute bottom-0 left-0 right-0 z-30 p-6 bg-[#FAFAF8]/95 backdrop-blur-sm border-t-2 border-[#1A1A1A]">
            <div className="space-y-4">
              <h1 className="text-3xl font-black leading-tight text-[#FF6B35] uppercase">
              ...
              <Button
                onClick={() => setIsWaitlistOpen(true)}
                className="w-full bg-[#FF6B35] hover:bg-[#FF8C5A] text-white font-mono text-sm uppercase py-3"
              >
                APPLY NOW →
              </Button>
            </div>

...
const SupportedDapps = () => {
  ...
  return (
    <section id="dapps" className="section-padding relative">
      <div className="container-custom">
        ...
        >
          <p className="eyebrow-accent mb-6">Ecosystem Integration</p>
        ...
        {activeNetwork === "arc" ? (
          ...
          >
            <div className="w-20 h-20 mx-auto rounded-xl bg-white/5 border border-white/10 flex items-center justify-center mb-6">
